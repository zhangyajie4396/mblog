...
-- Records of resource
-- ----------------------------
INSERT INTO `resource` VALUES ('2', null, '用户管理', '/html/role/list.html', 'fa fa-user icon-xlarge', '1');
INSERT INTO `resource` VALUES ('3', null, '角色管理', '/html/role/list.html', 'fa fa fa-registered icon-xlarge', '2');
